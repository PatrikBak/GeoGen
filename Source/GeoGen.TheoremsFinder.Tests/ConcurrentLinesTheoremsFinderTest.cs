...
{
    /// <summary>
    /// The test class for <see cref="ConcurrentLinesTheoremsFinder"/>.
    /// </summary>
    [TestFixture]
    public class ConcurrentLinesTheoremsFinderTest : TheoremsFinderTestBase<ConcurrentLinesTheoremsFinder>
    {
        [Test]
