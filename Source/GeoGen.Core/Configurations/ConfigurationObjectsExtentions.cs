...
namespace GeoGen.Core
{
    ...
    /// </summary>
    public static class ConfigurationObjectsExtentions
    {
        /// <summary>
        ...
        public static IReadOnlyList<ConfigurationObject> GetDefiningObjects(this IEnumerable<ConfigurationObject> objects)
        {
            ...
            void FindUsesAllDefiningObjects(ConfigurationObject configurationObject)
            {
                ...
                // Get the set holding the objects directly used in the definition
                // If we have a constructed object...
                var usedObjects = configurationObject is ConstructedConfigurationObject constructedObject
                    // Then we look at its flattened arguments
                    ? constructedObject.PassedArguments.FlattenedList.ToSet()
                    // Otherwise we have no internal objects
