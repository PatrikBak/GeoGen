...
namespace GeoGen.Analyzer
{
    ...
    /// representations, i.e. <see cref="AnalyticObject"/>s. This container assumes each object is present
    /// exactly ones and doesn't allow duplicity. It is also able to reconstruct all its objects.
    /// </summary>
    public interface IObjectsContainer : IEnumerable<(ConfigurationObject configurationObject, AnalyticObject analyticObject)>
    {
        /// <summary>
        ...
        void Add(IEnumerable<ConfigurationObject> objects, Func<List<AnalyticObject>> constructor);
        ...
        void TryAdd(ConfigurationObject configurationObject, Func<AnalyticObject> constructor, out bool objectConstructed, out ConfigurationObject equalObject);
