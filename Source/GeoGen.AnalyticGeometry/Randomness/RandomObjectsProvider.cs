...
namespace GeoGen.AnalyticGeometry
{
    ...
    public class RandomObjectsProvider : IRandomObjectsProvider
    {
        ...
        /// </summary>
        private readonly Dictionary<Type, HashSet<AnalyticObject>> _objects;
        ...
        public RandomObjectsProvider(IRandomnessProvider random)
        {
            ...
            _objects = new Dictionary<Type, HashSet<AnalyticObject>>();
        }
        ...
        public AnalyticObject NextRandomObject<T>() where T : AnalyticObject
        {
            // Pull the type
            var type = typeof(T);
        ...
        private HashSet<AnalyticObject> FindSetForType(Type type)
        {
            ...
            var set = new HashSet<AnalyticObject>();
