...
{
    /// <summary>
    /// The settings for <see cref="SortingGeometryFailureTracer"/>.
    /// </summary>
    public class SortingGeometryFailureTracerSettings
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SortingGeometryFailureTracerSettings"/> class.
        /// </summary>
        ...
        public SortingGeometryFailureTracerSettings(string failureFilePath, bool logFailures)
        {
