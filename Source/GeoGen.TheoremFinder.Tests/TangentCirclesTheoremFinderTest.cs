...
namespace GeoGen.TheoremFinder.Tests
{
    ...
    public class TangentCirclesTheoremFinderTest : TypedTheoremFinderTestBase<TangentCirclesTheoremFinder>
    {
        ...
        /// </summary>
        private static TangentCirclesTheoremFinder WithoutExcludingTangenciesInsidePicture => new TangentCirclesTheoremFinder(
        ...
        /// </summary>
        private static TangentCirclesTheoremFinder WithExcludingTangenciesInsidePicture => new TangentCirclesTheoremFinder(
            // Create the right settings
        ...
        public void Test_Triangle_With_Feurbach_Circle_And_Excircles_Without_Excluding_Tangencies()
        {
            ...
            var configuration = Configuration.DeriveFromObjects(Triangle, k, l, i, P, Q, R);
