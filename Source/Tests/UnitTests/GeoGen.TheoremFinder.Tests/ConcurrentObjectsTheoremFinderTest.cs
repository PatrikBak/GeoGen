...
{
    /// <summary>
    /// The test class for <see cref="ConcurrentObjectsTheoremFinder"/>.
    /// </summary>
    [TestFixture]
    public class ConcurrentObjectsTheoremFinderTest : TypedTheoremFinderTestBase<ConcurrentObjectsTheoremFinder>
    {
        [Test]
