...
namespace GeoGen.Constructor
{
    ...
    /// that should represent already drawn <see cref="ConfigurationObject"/>s within <see cref="PicturesOfConfiguration"/>.
    ...
    {
        /// <summary>
        /// Creates a new contextual picture that displays given <see cref="PicturesOfConfiguration"/>.
        ...
        ContextualPicture CreateContextualPicture(PicturesOfConfiguration pictures);
    }
}