        ...
        private void Add(ConfigurationObject configurationObject, bool isNew)
        {
            ...
            if (geometricalObject != null)
            {
                ...
                if (internalConfigurationObject != null)
                    throw new RegistrarException("An attempt to add an existing configuration object.");
            ...
            switch (configurationObject.ObjectType)
            {
                ...
                case ConfigurationObjectType.Circle:
                    ...
                    break;
                default:
                    throw new RegistrarException("Unknown type of configuration object.");
            }
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            switch (geometricalObject)
                            {
                                ...
                                default:
                                    throw new RegistrarException("Unknown type of geometrical object");
                            }
                        }
                        catch (AnalyticException)
                        {
                            ...
                            throw new RegistrarException("Reconstruction of the container failed.");
                        }
                    }
