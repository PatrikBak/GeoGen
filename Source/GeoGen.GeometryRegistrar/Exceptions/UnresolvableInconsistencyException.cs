...
{
    /// <summary>
    /// Represents an <see cref="RegistrarException"/> that is thrown when there are inconsistencies
    ...
    /// </summary>
    public class UnresolvableInconsistencyException : RegistrarException
    {
    }
}
