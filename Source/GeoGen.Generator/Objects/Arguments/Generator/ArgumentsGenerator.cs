...
namespace GeoGen.Generator
{
    ...
    public class ArgumentsGenerator : IArgumentsGenerator
    {
        ...
        public IEnumerable<Arguments> GenerateArguments(Configuration configuration, ConstructionWrapper construction)
        {
            // First we check if we can even perform the construction. Whether there are enough
            // objects to do so. If not, we simply break an empty container.
            ...
            // Let the factory create the container for the generated arguments
            ...
            foreach (var dictonaryForMatcher in _combinator.Combine(dictionaryForCombinator))
            {
                ...
                // If there are no equal arguments, return this one
        ...
        private bool CanWePerformConstruction(Configuration configuration, ConstructionWrapper construction)
        {
            ...
            foreach (var pair in construction.ObjectTypesToNeededCount)
            {
                ...
                var map = configuration.ObjectsMap;
