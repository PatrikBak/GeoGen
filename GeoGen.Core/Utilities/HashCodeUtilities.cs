...
namespace GeoGen.Core.Utilities
{
    ...
    {
        /// <summary>
        /// Gets an order independant hash code of a given collection, using a given function 
        ...
        public static int GetOrderIndependentHashCode<T>(IEnumerable<T> enumerable, Func<T, int> hashCoder)
        {
            var hash = 0;
        ...
        /// <summary>
        /// Gets an order dependant hash code of a given collection, using a given function 
        ...
        /// <param name="hashCoder">The function that takes an element and returns it's hash code.</param>
        /// <returns>The hash code.</returns>
        public static int GetOrderDependentHashCode<T>(IEnumerable<T> enumerable, Func<T, int> hashCoder)
        {
            var hash = 0;
