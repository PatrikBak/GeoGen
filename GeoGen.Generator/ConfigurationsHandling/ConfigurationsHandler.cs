...
namespace GeoGen.Generator.ConfigurationsHandling
{
    ...
    internal class ConfigurationsHandler : IConfigurationsHandler
    {
        ...
        /// </summary>
        private readonly IConfigurationsContainer _container;
        ...
        /// <param name="container">The configurations container.</param>
        public ConfigurationsHandler(IGradualAnalyzer analyzer, IConfigurationsContainer container)
        {
        ...
        public IEnumerable<GeneratorOutput> GenerateFinalOutput(IEnumerable<ConfigurationWrapper> configurations)
        {
            ...
            foreach (var configurationWrapper in configurations)
            {
                ...
                if (shouldBeExcluded)
                {
                    ...
                    {
                        _container.ForbidConfigurationsContaining(newObject);
                    }
                }
