...
namespace GeoGen.Generator.ConstructingConfigurations.ObjectsContainer
{
    ...
    internal sealed class ConfigurationObjectsContainer : StringBasedContainer<ConfigurationObject>, IConfigurationObjectsContainer
    {
        ...
        private readonly List<LooseConfigurationObject> _looseObjects;
        ...
        /// </summary>
        /// <param name="initialConfiguration">TODO: REDO</param>
        /// <param name="provider">The default full object to string provider.</param>
        public ConfigurationObjectsContainer(Configuration initialConfiguration, DefaultFullObjectToStringProvider provider)
        {
            ...
            _looseObjects = new List<LooseConfigurationObject>();
        ...
        public IEnumerable<ConfigurationObject> GetLooseObjects()
        {
            return _looseObjects;
        }
        ...
        private void Initialize(Configuration configuration)
        {
            ...
            foreach (var looseConfigurationObject in configuration.LooseObjects)
            {
                ...
                _looseObjects.Add(looseConfigurationObject);
            }
