...
namespace GeoGen.Generator.ConstructingConfigurations
{
    ...
    /// </summary>
    internal sealed class ConfigurationsManager : StringBasedContainer<Configuration>, IConfigurationsManager
    {
        ...
        /// <summary>
        /// Constructs a new configuration container with an initial configuration. This 
        /// container needs to use <see cref="IConfigurationConstructor"/>, for constructing 
        ...
        /// where it adds new objects from the output. Since it's string bases, it also needs a
        ...
        /// 
        /// TODO: This class will be changed. Review. Also: Can't we merge the to string
        /// function to one interface? Surely we can... 
        /// 
        /// </summary>
