...
namespace GeoGen.Analyzer.Test.Theorems.TheoremVerifiers
{
    ...
    public class ConcurrencyVerifierTest
    {
        ...
        private static ConcurrentObjectsVerifier Verifier() => new ConcurrentObjectsVerifier(new SubsetsProvider());
        ...
        private static ContextualContainer Container(Configuration configuration, params List<AnalyticalObject>[] objects)
        {
            ...
            return new ContextualContainer(configuration, _containers);
        }
        ...
        public void Test_Medians_Are_Concurrent()
        {
            ...
            var correctOutputs = Verifier().FindPotencialTheorems(container)
        ...
        public void Test_With_Orthocenter()
        {
            var looseObjects = new List<LooseConfigurationObject>
            {
                ...
                new LooseConfigurationObject(ConfigurationObjectType.Line) {Id = 4},  // Altitude from B on AC
                new LooseConfigurationObject(ConfigurationObjectType.Line) {Id = 5},  // Altitude from C on AB
                new LooseConfigurationObject(ConfigurationObjectType.Circle) {Id = 6} // Circle ADE, where D,E are the feets afforementioned altitutes
            };
