    ...
    public class ContextualContainerTest
    {
        private static ContextualContainer Container(Configuration configuration, params List<AnalyticalObject>[] objects)
        {
            ...
            var containers = objects.Select(analyticalObjects =>
            {
                ...
                var allObjects = configuration.LooseObjects;

                for (var i = 0; i < allObjects.Count; i++)
                {
                    var iCopy = i;
                    result.Add(new[] { allObjects[iCopy] }, c => new List<AnalyticalObject> { analyticalObjects[iCopy] });
                }
        ...
        public void Test_Plain_Triangle()
        {
            ...
            var lines = container.GetGeometricalObjects<LineObject>(new ContexualContainerQuery
            {
            ...
            var circles = container.GetGeometricalObjects<CircleObject>(new ContexualContainerQuery
            {
                Type = ContexualContainerQuery.ObjectsType.All,
                IncludeCirces = true,
                IncludePoints = false,
            ...
            var points = container.GetGeometricalObjects<PointObject>(new ContexualContainerQuery
            {
                Type = ContexualContainerQuery.ObjectsType.All,
                IncludeCirces = false,
                IncludePoints = true,
